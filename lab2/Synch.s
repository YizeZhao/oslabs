...
!   _temp_59 = _temp_57 XOR 1		(bool)
	...
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_59 then goto _Label_56 else goto _Label_55
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_55
	jmp	_Label_56
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (heldby) then goto _Label_62
	load	[r14+8],r1
	load	[r1+4],r1
	cmp	r1,r0
	be	_Label_62
...
!   Retrieve Result: targetName=_temp_75  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_77 = _temp_75 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_77 then goto _Label_74 else goto _Label_73
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_73
	jmp	_Label_74
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (t) then goto _Label_81
	load	[r14+-40],r1
	cmp	r1,r0
	be	_Label_81
!	jmp	_Label_80
...
!   Send message IsHeldByCurrentThread
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_107  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-9]
!   if _temp_107 then goto _Label_106 else goto _Label_105
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_105
	jmp	_Label_106
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if t == 0 then goto _Label_123		(int)
	load	[r14+-36],r1
	mov	0,r2
	cmp	r1,r2
	be	_Label_123
...
!   _temp_124 = t + 76
	...
	add	r1,76,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_124 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (t) then goto _Label_144
	load	[r14+-36],r1
	cmp	r1,r0
	be	_Label_144
	jmp	_Label_145
...
!   _temp_146 = t + 76
	...
	add	r1,76,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_146 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
