...
!   Retrieve Result: targetName=_temp_73  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   _temp_75 = _temp_73 XOR 0		(bool)
	loadb	[r14+-10],r1
	mov	0,r2
	xor	r1,r2,r1
	storeb	r1,[r14+-9]
!   if _temp_75 then goto _Label_72 else goto _Label_71
	loadb	[r14+-9],r1
	cmp	r1,0
	be	_Label_71
	jmp	_Label_72
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (t) then goto _Label_79
	load	[r14+-40],r1
	cmp	r1,r0
	be	_Label_79
!	jmp	_Label_78
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if _P_Thread_currentThread != heldby then goto _Label_94		(int)
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	load	[r14+8],r2
	load	[r2+4],r2
