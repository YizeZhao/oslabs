...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_221 = &_Global_waiting_customer_sem
	set	_Global_waiting_customer_sem,r1
	store	r1,[r14+-84]
!   Send message Down
	load	[r14+-84],r1
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_223 = &_Global_sb
	set	_Global_sb,r1
	store	r1,[r14+-76]
!   _temp_224 = _temp_223 + 12
	load	[r14+-76],r1
	add	r1,12,r1
	store	r1,[r14+-72]
!   _temp_227 = &_Global_sb
	set	_Global_sb,r1
	store	r1,[r14+-60]
!   _temp_228 = _temp_227 + 12
	load	[r14+-60],r1
	add	r1,12,r1
	store	r1,[r14+-56]
!   Data Move: _temp_226 = *_temp_228  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-64]
!   _temp_225 = _temp_226 + 1		(int)
	load	[r14+-64],r1
	mov	1,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   Data Move: *_temp_224 = _temp_225  (sizeInBytes=4)
	load	[r14+-68],r1
	load	[r14+-72],r2
	store	r1,[r2]
! SEND STATEMENT...
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_234 = &_Global_customer_status_sem
	set	_Global_customer_status_sem,r1
	store	r1,[r14+-32]
!   Send message Down
	load	[r14+-32],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_235 = &_Global_customer_status_sem
	set	_Global_customer_status_sem,r1
	store	r1,[r14+-28]
!   Send message Down
	load	[r14+-28],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_236 = &_Global_barber_done_sem
	set	_Global_barber_done_sem,r1
	store	r1,[r14+-24]
!   Send message Up
	load	[r14+-24],r1
...
!   _temp_238 = _temp_237 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-16]
!   Data Move: *_temp_238 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-16],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_262) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_262 [n ] into _temp_265
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-152]
!   Data Move: *_temp_265 = 69  (sizeInBytes=1)
	mov	69,r1
	load	[r14+-152],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if _Global_waiting_customer >= 5 then goto _Label_268		(int)
	set	_Global_waiting_customer,r1
	load	[r1],r1
	mov	5,r2
	cmp	r1,r2
...
!   if intIsZero (_temp_275) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_275 [n ] into _temp_278
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-108]
!   Data Move: *_temp_278 = 83  (sizeInBytes=1)
	mov	83,r1
	load	[r14+-108],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_281 = &_Global_waiting_customer_sem
	set	_Global_waiting_customer_sem,r1
	store	r1,[r14+-96]
!   Send message Up
	load	[r14+-96],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_282 = &_Global_barber_ready_sem
	set	_Global_barber_ready_sem,r1
	store	r1,[r14+-92]
!   Send message Down
	load	[r14+-92],r1
...
!   if intIsZero (_temp_283) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_283 [n ] into _temp_286
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-76]
!   Data Move: *_temp_286 = 66  (sizeInBytes=1)
	mov	66,r1
	load	[r14+-76],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_288 = &_Global_customer_status_sem
	set	_Global_customer_status_sem,r1
	store	r1,[r14+-68]
!   Send message Up
	load	[r14+-68],r1
...
!   _temp_290 = &_Global_sb
	set	_Global_sb,r1
	store	r1,[r14+-60]
!   _temp_291 = _temp_290 + 8
	load	[r14+-60],r1
	add	r1,8,r1
	store	r1,[r14+-56]
!   Data Move: _temp_289 = *_temp_291  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-64]
!   if intIsZero (_temp_289) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_289 [n ] into _temp_292
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-52]
!   Data Move: *_temp_292 = 70  (sizeInBytes=1)
	mov	70,r1
	load	[r14+-52],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_294 = &_Global_barber_done_sem
	set	_Global_barber_done_sem,r1
	store	r1,[r14+-44]
!   Send message Down
	load	[r14+-44],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_295 = &_Global_customer_status_sem
	set	_Global_customer_status_sem,r1
	store	r1,[r14+-40]
!   Send message Up
	load	[r14+-40],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_298 = &_Global_customer_status_sem
	set	_Global_customer_status_sem,r1
	store	r1,[r14+-32]
!   Send message Down
	load	[r14+-32],r1
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_300 = &_Global_sb
	set	_Global_sb,r1
	store	r1,[r14+-24]
!   _temp_301 = _temp_300 + 8
	load	[r14+-24],r1
	add	r1,8,r1
	store	r1,[r14+-20]
...
!   if intIsZero (_temp_299) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_299 [n ] into _temp_302
!     make sure index expr is >= 0
	load	[r14+8],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: *_temp_302 = 76  (sizeInBytes=1)
	mov	76,r1
	load	[r14+-16],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_348) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_349 = _temp_348 + 4
	load	[r14+-32],r1
	add	r1,4,r1
	store	r1,[r14+-28]
!   Data Move: *_temp_349 = bStat  (sizeInBytes=4)
	load	[r14+12],r1
	load	[r14+-28],r2
	store	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_350) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_351 = _temp_350 + 8
	load	[r14+-24],r1
	add	r1,8,r1
	store	r1,[r14+-20]
!   Data Move: *_temp_351 = cStat  (sizeInBytes=4)
	load	[r14+16],r1
	load	[r14+-20],r2
	store	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_352) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_353 = _temp_352 + 12
	load	[r14+-16],r1
	add	r1,12,r1
	store	r1,[r14+-12]
!   Data Move: *_temp_353 = numOfChair  (sizeInBytes=4)
	load	[r14+20],r1
	load	[r14+-12],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-340]
!   Data Move: *_temp_368 = 69  (sizeInBytes=1)
	mov	69,r1
	load	[r14+-340],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_371) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_372 = _temp_371 + 8
	load	[r14+-328],r1
	add	r1,8,r1
	store	r1,[r14+-324]
!   Data Move: _temp_370 = *_temp_372  (sizeInBytes=4)
	load	[r14+-324],r1
	load	[r1],r1
	store	r1,[r14+-332]
!   if intIsZero (_temp_370) then goto _runtimeErrorNullPointer
	load	[r14+-332],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_370 [0 ] into _temp_373
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-320]
!   Data Move: *_temp_373 = 83  (sizeInBytes=1)
	mov	83,r1
	load	[r14+-320],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_378) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_379 = _temp_378 + 12
	load	[r14+-300],r1
	add	r1,12,r1
	store	r1,[r14+-296]
!   Data Move: _temp_377 = *_temp_379  (sizeInBytes=4)
	load	[r14+-296],r1
	load	[r1],r1
	store	r1,[r14+-304]
!   _temp_376 = _temp_377 - 1		(int)
	load	[r14+-304],r1
	mov	1,r2
	sub	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-276]
!   Data Move: *_temp_384 = 69  (sizeInBytes=1)
	mov	69,r1
	load	[r14+-276],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_387) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_388 = _temp_387 + 8
	load	[r14+-264],r1
	add	r1,8,r1
	store	r1,[r14+-260]
!   Data Move: _temp_386 = *_temp_388  (sizeInBytes=4)
	load	[r14+-260],r1
	load	[r1],r1
	store	r1,[r14+-268]
!   if intIsZero (_temp_386) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_386 [1 ] into _temp_389
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-256]
!   Data Move: *_temp_389 = 83  (sizeInBytes=1)
	mov	83,r1
	load	[r14+-256],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_397) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_398 = _temp_397 + 4
	load	[r14+-224],r1
	add	r1,4,r1
	store	r1,[r14+-220]
!   Data Move: *_temp_398 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-220],r2
	store	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_406) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_406 [0 ] into _temp_409
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-176]
!   Data Move: *_temp_409 = 66  (sizeInBytes=1)
	mov	66,r1
	load	[r14+-176],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_411) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_412 = _temp_411 + 4
	load	[r14+-168],r1
	add	r1,4,r1
	store	r1,[r14+-164]
!   Data Move: *_temp_412 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-164],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-144]
!   Data Move: *_temp_417 = 70  (sizeInBytes=1)
	mov	70,r1
	load	[r14+-144],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_419) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_419 [0 ] into _temp_422
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-124]
!   Data Move: *_temp_422 = 76  (sizeInBytes=1)
	mov	76,r1
	load	[r14+-124],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_424) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_425 = _temp_424 + 4
	load	[r14+-116],r1
	add	r1,4,r1
	store	r1,[r14+-112]
!   Data Move: *_temp_425 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-112],r2
	store	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   if intIsZero (_temp_433) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_433 [1 ] into _temp_436
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: *_temp_436 = 66  (sizeInBytes=1)
	mov	66,r1
	load	[r14+-68],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   _temp_439 = _temp_438 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-56]
!   Data Move: *_temp_439 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-56],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: *_temp_444 = 70  (sizeInBytes=1)
	mov	70,r1
	load	[r14+-36],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   if intIsZero (_temp_446) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_446 [1 ] into _temp_449
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: *_temp_449 = 76  (sizeInBytes=1)
	mov	76,r1
	load	[r14+-16],r2
	storeb	r1,[r2]
! SEND STATEMENT...
...
!   _temp_544 = _temp_543 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   Data Move: _temp_542 = *_temp_544  (sizeInBytes=4)
	load	[r14+-20],r1
	load	[r1],r1
	store	r1,[r14+-28]
!   if _temp_542 != 1 then goto _Label_541		(int)
	load	[r14+-28],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_541
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if i == customer then goto _Label_565		(int)
	load	[r14+-48],r1
	load	[r14+12],r2
	cmp	r1,r2
	be	_Label_565
...
!   if intIsZero (_temp_568) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Move address of _temp_568 [i ] into _temp_571
!     make sure index expr is >= 0
	load	[r14+-48],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: _temp_567 = *_temp_571  (sizeInBytes=1)
	load	[r14+-16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_567  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
	mov	277,r13		! source line 277
...
!   if intIsZero (_temp_591) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_592 = _temp_591 + 12
	load	[r14+-36],r1
	add	r1,12,r1
	store	r1,[r14+-32]
!   Data Move: _temp_590 = *_temp_592  (sizeInBytes=4)
	load	[r14+-32],r1
	load	[r1],r1
	store	r1,[r14+-40]
!   _temp_589 = _temp_590 + 1		(int)
	load	[r14+-40],r1
	mov	1,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
_Label_585:
!   Perform the FOR-LOOP termination test
!   if i > _temp_593 then goto _Label_588		
	load	[r14+-48],r1
	load	[r14+-28],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (_temp_600) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_601 = _temp_600 + 12
	load	[r14+-16],r1
	add	r1,12,r1
	store	r1,[r14+-12]
!   Data Move: _temp_599 = *_temp_601  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_598  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-48]
_Label_594:
!   Perform the FOR-LOOP termination test
!   if i > _temp_599 then goto _Label_597		
	load	[r14+-48],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
