...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: SleepAwake = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_138 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-68]
!   Move address of _temp_138 [p ] into _temp_139
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-64]
!   Data Move: *_temp_139 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-64],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_183 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-56]
!   Move address of _temp_183 [p ] into _temp_184
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_190 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-40]
!   Move address of _temp_190 [Left ] into _temp_191
!     make sure index expr is >= 0
	load	[r14+-72],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_189 = *_temp_191  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_189 != 1 then goto _Label_188		(int)
	load	[r14+-44],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_188
...
!   _temp_193 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_193 [Right ] into _temp_194
!     make sure index expr is >= 0
	load	[r14+-76],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
